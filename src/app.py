...
activities = {
    ...
    "Basketball Club": {
        "description": "Competitive and recreational basketball sessions",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "sophia.a@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        "description": "Public speaking, argumentation, and tournament preparation",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(
            status_code=400, detail="Student is not registered for this activity")
